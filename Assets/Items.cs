...
public class Items
{
    ...
    public static readonly Item specialRock = new Item("specialRock", "Special Rock", "a special rock", "An incredibly rare and special rock. You can tell because of the way it is", "a special-looking rock", 999, 1, 1);
